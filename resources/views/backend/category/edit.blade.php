                    ...
                    <div class="card-body">
                        <form action="{{ route('category.update',$category->id) }}" method="post">
                            ...
                            <div class="form-group mt-1">
                              ...
                              <input type="text" class="form-control mt-1 @error('category_name') is-invalid @enderror" value="{{ $category->category_name }}"  id="category_name" placeholder="Write Your Category Name..." name="category_name">
                                @error('category_name')
                            ...
                            <button type="submit" class="btn btn-outline-success mt-2">Update Category</button>
                        </form>
                    </div>
            </div>
        </div>
